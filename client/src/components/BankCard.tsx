...
import { Star, ChevronDown, ChevronUp, Zap, Check, X, ExternalLink, Info } from 'lucide-react';
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                  ...
                  <div className="space-y-1">
                    {[
                      { label: 'FSCS Protected',        value: bank.fscsProtection      },
                      { label: 'Overdraft Available',   value: bank.overdraft           },
                      { label: 'International Payments',value: bank.internationalPayments},
                      { label: 'Cheque Deposits',       value: bank.chequeDeposits      },
                    ].map(({ label, value }) => (
