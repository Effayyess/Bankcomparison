...
when choosing RBS, ensuring alignment with their financial management needs and growth plans.` },
  ...
  savingsProducts: [
    {
      productName: 'Starling Business Fixed Saver',
      type: 'fixed-rate',
      aerLabel: '2.50% AER',
      aer: 2.50,
      term: '1 year fixed',
      minDepositLabel: '£2,000',
      minDeposit: 2000,
      maxDeposit: 1000000,
...
export const savingsAccounts: BusinessSavingsAccount[] = [
  ...
  {
    id: 'starling-business-fixed-saver',
    provider: 'Starling Bank',
    productName: 'Starling Business Fixed Saver',
    ...
    pros: [
      ...
      'Fixed rate for 12 months — 2.50% AER',
      'Integrated with Starling Business current account',
      'Minimum deposit from \u00a32,000',
    ],
    cons: [
      '2.50% AER \u2014 lower than specialist savings banks',
      'Only available to Starling current account holders',
      'Funds locked for 12 months',
      'Interest paid on maturity only',
    ],
    summary: "Starling's Business Fixed Saver offers a 2.50% AER fixed rate for 12 months, available to Starling Business current account holders.",
