...
export const banks: BankAccount[] = [
  {
    ...
    plans: [
      {
        ...
        monthlyFeeNum: 0,
        features: ['Free day-to-day digital banking', 'App, online, branch & Post Office access', 'Business overdraft (subject to status)', 'FSCS protected up to £85,000', '£100 Amazon Gift Card (new customers)'],
    ...
    openingFee: 'Free',
    creditCheck: true,
    suitableFor: ['sole-trader', 'limited-company', 'small-business', 'startup', 'established-business'],
    hasAccounting: true,
  ...
  },
  {
    ...
    plans: [
      {
        name: 'Free',
        price: 'Free',
        priceNote: '20 free transfers/month',
        monthlyFeeNum: 0,
        features: ['20 free UK transfers/month', 'Built-in invoicing', 'Xero, QuickBooks, FreeAgent integration', 'FSCS protected', 'No credit check'],
        highlight: 'Best for getting started',
      },
      {
        name: 'Plus',
        price: '£9.99/month',
        priceNote: 'Unlimited transfers',
        monthlyFeeNum: 9.99,
        features: ['Unlimited free UK transfers', 'Everything in Free', 'Priority customer support', 'Cashback on card spend'],
      },
    ],
    trustpilot: 4.1,
    appRating: 4.6,
    openingFee: 'Free',
    creditCheck: false,
    suitableFor: ['sole-trader', 'limited-company', 'small-business', 'startup', 'freelancer', 'contractor'],
    hasAccounting: true,
    ...
    plans: [
      {
        ...
        monthlyFeeNum: 0,
        features: ['12 months free banking', 'Branch & Post Office access', 'Overdraft available', 'FSCS protected', '£200 cashback offer'],
  ...
  },
  {
    ...
    plans: [
      {
        ...
        priceNote: 'No monthly fee',
        monthlyFeeNum: 0,
        features: ['Free online transfers', 'Branch access', 'Overdraft available', 'FSCS protected', 'Cashback on spending'],
        highlight: 'Best for free banking with branches',
      },
    ],
    trustpilot: 1.8,
    appRating: 4.2,
    openingFee: 'Free',
    creditCheck: true,
    suitableFor: ['sole-trader', 'limited-company', 'small-business', 'freelancer'],
    hasAccounting: true,
    hasBranchAccess: true,
    hasCashDeposits: true,
    hasFastOpening: false,
    ...
    plans: [
      {
        ...
        monthlyFeeNum: 0,
        features: ['5 free transfers/month', 'Multi-currency accounts', 'Business debit card', 'Basic expense management'],
      },
      {
        name: 'Grow',
        price: '£19/month',
        ...
        monthlyFeeNum: 19,
        features: ['100 free transfers/month', 'Multi-currency accounts', 'Bulk payments', 'Advanced expense management', 'API access'],
    ...
    plans: [
      {
        ...
        priceNote: 'No monthly fee',
        monthlyFeeNum: 0,
        features: ['60+ currency accounts', 'Free international transfers', 'Business debit cards', 'Accounting integrations', 'No credit check'],
  ...
  },
  {
    ...
    openingFee: 'Free',
    creditCheck: true,
    suitableFor: ['limited-company', 'startup', 'small-business', 'sole-trader'],
    hasAccounting: true,
    hasBranchAccess: true,
    hasCashDeposits: true,
    hasFastOpening: false,
  ...
  },
  {
    ...
    openingFee: 'Free',
    creditCheck: true,
    suitableFor: ['sole-trader', 'limited-company', 'small-business'],
    hasAccounting: false,
    hasBranchAccess: true,
    hasCashDeposits: true,
    hasFastOpening: false,
    ...
    plans: [
      {
        ...
        priceNote: 'No monthly fee',
        monthlyFeeNum: 0,
        features: ['10 free transfers/month', 'No credit check', 'FSCS protected', 'Overdraft available', 'Post Office cash deposits'],
  ...
  },
  {
    ...
    plans: [
      {
        ...
        priceNote: 'Then £8.50/month',
        monthlyFeeNum: 0,
        features: ['12 months free banking', 'Branch & Post Office access', 'Overdraft available', 'FSCS protected', 'International payments'],
    ...
    openingFee: 'Free',
    creditCheck: true,
    suitableFor: ['limited-company', 'established-business', 'small-business', 'sole-trader'],
    hasAccounting: true,
    hasBranchAccess: true,
    hasCashDeposits: true,
    hasFastOpening: false,
  ...
  },
  {
    ...
    openingFee: 'Free',
    creditCheck: true,
    suitableFor: ['sole-trader', 'limited-company', 'small-business', 'charity'],
    hasAccounting: false,
    hasBranchAccess: true,
    hasCashDeposits: true,
    hasFastOpening: false,
    ...
    plans: [
      {
        name: 'Lite',
        price: 'Free',
        priceNote: 'Basic features',
        monthlyFeeNum: 0,
        features: ['Free UK transfers', 'Instant notifications', 'Tax pots', 'FSCS protected', 'Business debit card'],
        highlight: 'Best for getting started',
      },
      {
        name: 'Pro',
        price: '£5/month',
        priceNote: 'Full features',
        monthlyFeeNum: 5,
        features: ['Everything in Lite', 'Accounting integrations (Xero, QuickBooks, FreeAgent)', 'Invoice management', 'Multiple team members', 'Priority support'],
        highlight: 'Most popular',
      },
    ],
    trustpilot: 4.4,
    ...
    plans: [
      {
        name: 'Pay As You Go',
        price: 'Free',
        priceNote: '3 free transfers/month',
        monthlyFeeNum: 0,
        features: ['3 free transfers/month', 'Built-in invoicing', 'Tax reminders', 'FSCS protected', 'No credit check'],
      ...
      },
      {
        ...
        priceNote: 'Unlimited transfers',
        monthlyFeeNum: 14.90,
        features: ['Unlimited transfers', 'Everything in PAYG', 'AI assistant', 'Accounting integrations', 'Multiple team members'],
  ...
  },
  {
    ...
    openingFee: 'Free',
    creditCheck: false,
    suitableFor: ['sole-trader', 'limited-company', 'startup', 'freelancer', 'contractor'],
    hasAccounting: true,
    hasBranchAccess: false,
    hasCashDeposits: true,
    hasFastOpening: true,
...
export const accountTypeCategories = [
  ...
  { type: 'joint', label: 'Joint Accounts', icon: '🤝', description: 'Shared business accounts', suitability: 'partnership' },
  ...
  { type: 'multi-director', label: 'Multi-Director', icon: '👥', description: 'Multiple signatories', suitability: 'partnership' },
...
export const businessTypeCards = [
  { title: 'Sole Trader', href: '/best-business-bank-account-sole-trader', icon: '👤', desc: 'Best accounts for self-employed individuals', color: 'oklch(0.93 0.04 210)', suitability: 'sole-trader' },
  { title: 'Limited Company', href: '/best-business-bank-account-limited-company', icon: '🏢', desc: 'Accounts for Ltd companies', color: 'oklch(0.93 0.04 240)', suitability: 'limited-company' },
  { title: 'Contractor', href: '/best-business-bank-account-contractor', icon: '🔧', desc: 'Contractor-friendly banking', color: 'oklch(0.93 0.04 60)', suitability: 'contractor' },
  { title: 'Freelancer', href: '/best-business-bank-account-freelancer', icon: '💻', desc: 'Self-employed banking solutions', color: 'oklch(0.93 0.04 290)', suitability: 'freelancer' },
  { title: 'Startup', href: '/best-business-bank-account-startup', icon: '🚀', desc: 'New business bank accounts', color: 'oklch(0.93 0.04 25)', suitability: 'startup' },
  { title: 'Small Business', href: '/best-business-bank-account-small-business', icon: '🏪', desc: 'For established small businesses', color: 'oklch(0.93 0.04 45)', suitability: 'small-business' },
  { title: 'Partnership', href: '/best-business-bank-account-partnership', icon: '🤝', desc: 'Joint business accounts', color: 'oklch(0.93 0.04 162)', suitability: 'partnership' },
  { title: 'E-commerce', href: '/best-business-bank-account-ecommerce', icon: '🛒', desc: 'Multi-currency and payment integrations', color: 'oklch(0.95 0.04 45)', suitability: 'ecommerce' },
];
