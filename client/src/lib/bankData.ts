...
export const banks: BankAccount[] = [
  {
    ...
    reviewContent: [
      ...
      { heading: 'FSCS Protection', body: 'HSBC is authorised by the Prudential Regulation Authority (PRA) and regulated by the Financial Conduct Authority (FCA) and PRA. Eligible deposits held with HSBC are protected by the Financial Services Compensation Scheme (FSCS) up to £120,000 per person per authorised institution. This provides businesses with a significant safety net and is an important consideration when choosing a business bank account.' },
    ],
    plans: [
      {
  ...
  },
  {
    ...
    reviewContent: [
      ...
      { heading: 'NatWest Backing', body: 'As a NatWest product, Mettle benefits from the security and reliability of one of the UK\'s largest banks. Mettle accounts are FSCS protected up to £120,000, providing businesses with a significant safety net. NatWest\'s backing also means that Mettle is subject to the same regulatory standards as a traditional high street bank.' },
