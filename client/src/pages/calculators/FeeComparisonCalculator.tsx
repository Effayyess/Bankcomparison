...
const feeRows: BankFeeRow[] = [
  ...
  },
  {
    ...
    // 5 free transfers/mo then 20p; 0.99% cash (min £2.50) at Post Office; 20p + 1.5% intl
    monthlyFee: 0, openingFee: 'Free', creditCheck: false, fscsProtection: true,
    freeTransfersPerMonth: 5, perTransferFee: 20, perIncomingFee: 0,
    cashDepositAccepted: true, cashDepositRate: 0.99, cashDepositMin: 250, cashWithdrawalFee: 'Free ATM',
    intlTransferFee: 20, intlTransferPct: 1.5,
  ...
  },
  {
    ...
    monthlyFee: 0, openingFee: 'Free', creditCheck: false, fscsProtection: true,
    freeTransfersPerMonth: 9999, perTransferFee: 0, perIncomingFee: 0,
    cashDepositAccepted: true, cashDepositRate: 0, cashDepositMin: 100, cashWithdrawalFee: 'Free ATM',
    intlTransferFee: 0, intlTransferPct: 1.0,
    hasOverdraft: false, hasAccounting: true, hasBranchAccess: false, hasFastOpening: true, hasMultiCurrency: false,
  ...
  },
  {
    ...
    // Grow plan £30/mo: 100 free local transfers then 20p; 5 free intl then £5+0.6%
    monthlyFee: 30, openingFee: 'Free', creditCheck: false, fscsProtection: false,
    freeTransfersPerMonth: 100, perTransferFee: 20, perIncomingFee: 0,
    cashDepositAccepted: false, cashDepositRate: 0, cashDepositMin: 0, cashWithdrawalFee: '2% above limit',
    intlTransferFee: 500, intlTransferPct: 0.6,
  ...
  },
  {
    ...
    // Free first 12 months then £8.50/mo; 0.6% cash; £15+2.75% intl
    monthlyFee: 8.50, openingFee: 'Free (12mo free)', creditCheck: true, fscsProtection: true,
    freeTransfersPerMonth: 0, perTransferFee: 35, perIncomingFee: 0,
    cashDepositAccepted: true, cashDepositRate: 0.6, cashDepositMin: 0, cashWithdrawalFee: 'Free ATM',
    intlTransferFee: 1500, intlTransferPct: 2.75,
    hasOverdraft: true, hasAccounting: true, hasBranchAccess: true, hasFastOpening: false, hasMultiCurrency: false,
  ...
  },
  {
    ...
    monthlyFee: 0, openingFee: 'Free', creditCheck: false, fscsProtection: true,
    freeTransfersPerMonth: 9999, perTransferFee: 0, perIncomingFee: 95,
  ...
  },
  {
    ...
    monthlyFee: 0, openingFee: 'Free', creditCheck: false, fscsProtection: true,
    freeTransfersPerMonth: 9999, perTransferFee: 0, perIncomingFee: 0,
    cashDepositAccepted: true, cashDepositRate: 0, cashDepositMin: 275, cashWithdrawalFee: 'Free ATM',
