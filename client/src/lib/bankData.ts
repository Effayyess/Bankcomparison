...
export const banks: BankAccount[] = [
  {
    ...
    reviewContent: [
      { heading: `Overview`, body: `The **HSBC Small Business Banking Account** is designed to cater to the financial needs of:
...
Benchmarking it against industry standards and market expectations.` },
      { heading: `Pricing & Fees`, body: `Monthly fees:
...
The tiered approach allows businesses to select a plan matching their current needs and upgrade as they grow or require more personalized banking support. This flexibility is a strength, especially for businesses anticipating scale or those preferring a gradual approach to enhanced services.` },
      { heading: `Features & Tools`, body: `Overdraft Facility:
...
Overall, HSBC's Small Business Banking Account is a well-rounded, reliable banking solution suitable for a wide range of small businesses in the UK. It is particularly suited for those seeking a blend of digital convenience and physical bank access without monthly fees.` },
  ...
  savingsProducts: [
    {
      productName: 'Tide Instant Saver',
      type: 'easy-access',
      aerLabel: '4.00% AER',
      aer: 4.00,
      term: 'Instant access',
...
It aims to help UK business owners assess whether Tide fits their banking needs.` },
      { heading: `Pricing & Fees`, body: `Account Plans:
...
2. Geared towards businesses requiring cost-effective international payment solutions` },
      { heading: `Account Plans`, body: `Core Plan:
...
These pros and cons highlight that while the World Account is highly suitable for digital-first, internationally focused businesses, it may not replace traditional bank accounts for firms needing comprehensive banking services.` },
      { heading: `Verdict`, body: `The WorldFirst Global Business Account is a purpose-built, cost-effective solution for UK businesses engaged in international trade, e-commerce, or those requiring multi-currency management. Its offering excels in delivering:
...
These features are built directly into the account interface, making it particularly attractive for business owners who want to reduce manual bookkeeping tasks.` },
      { heading: `Pricing & Fees`, body: `Pricing model:
...
providing a balanced and comprehensive insight into its offerings.` },
      { heading: `Pricing & Fees`, body: `Pricing Plans:
...
2. The premium tiers are expensive compared to traditional banks and challenger banks, especially considering the FX fees and absence of some conventional banking features.` },
      { heading: `Account Plans`, body: `Wallester Business Account is structured into four primary plans: **Free**, **Premium**, **Platinum**, and **Enterprise**, each designed to meet different business needs and scales.
...
The availability of a generous free plan with up to **300 virtual cards** sets Wallester apart from many competitors by enabling significant card issuance without upfront costs.` },
      { heading: `Features & Tools`, body: `Virtual Cards:
...
3. Prospective customers should carefully assess their transaction patterns, card usage, and service expectations to determine if Wallester aligns with their operational model.` },
  ...
  },
  {
    ...
    reviewContent: [
      { heading: `Overview`, body: `Lloyds Bank Business Account is a widely recognized banking solution tailored for UK-based businesses. It serves a broad range of entities including:
...
3. It may not be the cheapest option for high-volume or cash-intensive businesses.` },
      { heading: `Account Plans`, body: `Monthly fees:
...
5. While the Trustpilot score is respectable, mixed reviews highlight occasional frustrations common in traditional banking, reminding businesses to consider service quality expectations carefully.` },
      { heading: `Verdict`, body: `Lloyds Bank Business Account stands out as a strong contender for small to medium-sized UK businesses seeking a reliable, well-rounded banking solution that combines traditional branch access with modern digital tools.
...
Businesses should carefully evaluate which plan aligns best with their transaction volumes and operational needs, considering the varying fees and benefits.` },
      { heading: `Features & Tools`, body: `The Co-operative Bank Business Current Account is equipped with a robust suite of features and tools designed to facilitate smooth banking operations for businesses of all sizes.
...
In summary, while the Co-operative Bank excels in ethical values, customer service, and integration capabilities, potential customers should carefully assess fee structures, digital tool limitations, and suitability for their business type.` },
      { heading: `Verdict`, body: `The Co-operative Bank Business Current Account stands out in the UK business banking landscape due to its strong ethical foundations and commitment to supporting a broad spectrum of business types, including:
...
making it a strong contender for micro and small businesses that operate primarily online or with minimal cash-handling needs.` },
      { heading: `Pricing & Fees`, body: `Pricing structure:
...
However, heavy users of cash deposits or international payments may find the transaction fees impact the overall affordability, regardless of plan choice.` },
      { heading: `Features & Tools`, body: `Countingup differentiates itself in the UK business banking landscape by integrating advanced bookkeeping and tax tools directly into its app, creating an all-in-one financial management platform.
...
5. No upgrade path for businesses growing beyond the **£1 million turnover cap**.` },
      { heading: `Features & Tools`, body: `The Virgin Money M Account for Business offers a range of features tailored to small business banking needs, emphasizing digital convenience and practical business insights.
...
These pros and cons highlight the Virgin Money M Account for Business as a solid option within its niche but with certain constraints that businesses must consider in line with their specific needs.` },
      { heading: `Verdict`, body: `The Virgin Money M Account for Business is a compelling business banking option for startups, sole traders, and small businesses with annual turnover under **£1 million** seeking a cost-effective, digitally focused banking solution.
...
The Virgin Money M Account for Business is best suited to small enterprises prioritising fee-free digital banking with the option for occasional branch support, and who do not require overdraft facilities or extensive international banking services. Businesses fitting this profile will find a practical, well-rounded account that balances cost, convenience, and useful business tools.` },
  ...
  savingsProducts: [
    {
      productName: 'Revolut Business Savings Account',
      type: 'easy-access',
      aerLabel: '2.15% AER',
      aer: 2.15,
      term: 'Instant access',
...
3. The value added through multi-currency support and integrated financial tools may justify these fees for businesses with international and digital needs.` },
      { heading: `Account Plans`, body: `Revolut Business offers three distinct account plans designed to suit different business sizes and transaction needs.
...
- Transparent tiering and inclusion of metal cards in higher plans add value for customers seeking premium banking tools` },
      { heading: `Features & Tools`, body: `Multi-Currency Support:
...
2. Especially suitable for businesses prioritising digital banking and cost-effective basic services` },
      { heading: `Account Plans`, body: `Monzo offers three distinct business account plans to cater to varying business needs and sizes, providing a tiered approach to features and pricing.
...
This plan is suitable for businesses with growing teams that need shared access to financial management tools while maintaining control and transparency.` },
      { heading: `Features & Tools`, body: `Mobile App:
...
require a paid monthly subscription (Pro or Team), which may add to operating costs for growing businesses.` },
      { heading: `Verdict`, body: `Monzo Business Account is a compelling choice for UK-based sole traders, freelancers, startups, and small limited companies seeking a modern, mobile-first banking experience. Its **free Lite plan** provides an accessible entry point for businesses needing basic banking capabilities without monthly fees.
...
Monzo is best suited to tech-savvy business owners comfortable with digital banking who value convenience, transparency, and integration with modern accounting tools. It offers a powerful alternative to traditional banks for small businesses looking to streamline their finances in an increasingly digital world, provided they are comfortable operating without a physical branch network or traditional customer service channels.` },
  ...
  },
  {
    ...
    reviewContent: [
      { heading: `Overview`, body: `The Barclays Business Current Account is a prominent offering from one of the UK's leading high-street banks. It targets a wide range of customers including:
...
might need to explore additional services or supplementary products.` },
      { heading: `Features & Tools`, body: `The Barclays Business Current Account is packed with features that cater to a wide spectrum of business banking needs. Starting with the basic transactional services, customers benefit from:
...
This is especially important for tax compliance and strategic decision-making.` },
      { heading: `Customer Service`, body: `Customer service is a critical factor for business banking customers, who often require timely and efficient support due to the nature of their operations. Barclays offers customer support through multiple channels, including:
...
A monthly fee of **£8.50** applies after the initial 12-month free period. This may impact businesses with tight cash flow or those seeking entirely fee-free banking solutions.` },
      { heading: `Verdict`, body: `The Barclays Business Current Account stands out as a solid choice for startups, sole traders, SMEs, and charities that value a well-established high-street bank with wide physical presence and integrated digital tools. 
...
Prospective customers should weigh the benefits against potential service challenges and specific fee structures to determine alignment with their operational needs.` },
  ...
  },
  {
    ...
    reviewContent: [
      { heading: `Overview`, body: `The RBS Business Account is a traditional business banking solution offered by the Royal Bank of Scotland (RBS), a major UK banking institution with a long heritage. It caters to a wide range of business types including:
...
- A Community Account designed specifically for non-profit organisations` },
      { heading: `Pricing & Fees`, body: `Start-up Account:
...
when choosing RBS, ensuring alignment with their financial management needs and growth plans.` },
  ...
  },
  {
    ...
    slug: 'starling-bank',
    type: 'digital',
    logo: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663463055847/WhPsiOyytnvKHbiM.png',
    logoColor: '#6935D8',
...
Overall, Starling Bank is a forward-thinking institution aligning closely with the evolving demands of modern UK businesses.` },
  ...
  },
  {
    ...
    reviewContent: [
      { heading: `Overview`, body: `Wise Business Account is a financial solution designed for UK businesses that require efficient multi-currency management, international payments, and straightforward banking without the complexities of traditional banks. Established as part of Wise, formerly known as TransferWise, this account caters to a wide range of business types.
...
5. Limited Native Accounting Integrations: While Sage integration is strong, indirect integrations via Open Banking for others may not be as seamless as competitors offering a wider range of native integrations.` },
      { heading: `Verdict`, body: `The Cynergy Bank Business Current Account presents a compelling proposition for UK-based sole traders, small to medium-sized enterprises, and companies seeking a cost-effective, digitally focused banking solution with valuable features.
...
3. Reduce administrative burdens` },
      { heading: `Customer Service`, body: `Support Model:
...
Businesses fitting this profile will find a comprehensive and scalable banking partner in Equals Money. However, those with more traditional banking needs should carefully assess the platform’s limitations before committing.` },
  ...
  },
  {
    ...
    slug: 'mettle',
    type: 'digital',
    logo: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663463055847/NlNXzSONHOBiCQwy.png',
    logoColor: '#1A1A2E',
...
4. Cash-heavy businesses should carefully consider the costs associated with deposits and ATM withdrawals.` },
      { heading: `Account Plans`, body: `Mettle’s account structure is straightforward yet flexible, catering to different business needs through two plans.
...
For these users, Mettle offers an excellent blend of modern banking, accounting integration, and user-friendly design, making it a strong contender in the competitive UK business banking landscape.` },
  ...
  },
  {
    ...
    welcomeOffer: 'Up to 4.00% AER on 1-year fixed savings',
    welcomeOfferDetail: "Aldermore offers FSCS-protected business savings accounts with competitive rates — 2.45% AER easy access, 4.00% AER 95-day notice, 3.65% AER 6-month fixed, and 4.00% AER 1-year fixed. Minimum deposit £1,000. No monthly fee.",
    pros: [
      'FSCS protected up to £85,000 per authorised institution',
      'Competitive savings rates — up to 4.00% AER on 1-year fixed',
      'Easy access, 95-day notice, 6-month and 1-year fixed-rate options available',
    ...
    reviewContent: [
      {
        heading: 'Overview',
        body: 'Aldermore Bank is a UK-based specialist savings and lending bank, authorised by the Prudential Regulation Authority (PRA) and regulated by the Financial Conduct Authority (FCA). Unlike high street banks, Aldermore focuses exclusively on savings and lending products — meaning businesses that open an Aldermore savings account benefit from a provider whose entire focus is on delivering competitive rates and protecting customer deposits.\n\nAldermore offers four types of business savings accounts: easy access, 95-day notice, 6-month fixed, and 1-year fixed-rate bonds. All accounts are FSCS protected up to £120,000 per authorised institution, and all can be managed online or by phone.',
      },
      {
        heading: 'Savings Rates & Products',
        body: 'Aldermore offers competitive savings rates for UK businesses. As of March 2026, the rates are:\n\n- **Easy Access Business Savings Account**: 2.45% AER — instant access, interest paid monthly\n- **95-Day Notice Business Savings Account**: 4.00% AER — 95 days notice required, interest paid monthly\n- **6-Month Fixed Rate Business Savings Account**: 3.65% AER — funds locked for 6 months, interest paid on maturity\n- **1-Year Fixed Rate Business Savings Account**: 4.00% AER — funds locked for 12 months, interest paid on maturity\n\nAll accounts require a minimum deposit of £1,000. FSCS protection applies up to £120,000.',
      },
      {
        heading: 'FSCS Protection',
        body: 'All Aldermore business savings accounts are fully FSCS protected up to £120,000 per authorised institution. This means your business deposits are protected by the UK government-backed Financial Services Compensation Scheme in the unlikely event that Aldermore were to fail. This is a critical distinction from e-money institutions such as Revolut, which use safeguarding rather than FSCS protection.',
      },
      {
        heading: 'Who Is It Best For?',
        body: 'Aldermore Business Savings is best suited to:\n\n- **Businesses with surplus cash** looking to earn a competitive return\n- **Companies with predictable cash flow** who can commit funds for 95 days or 6-12 months for higher rates\n- **Businesses that prioritise FSCS protection** over the highest possible rate\n- **Charities, not-for-profit organisations, and SMEs** of all sizes\n\nAldermore does not offer a business current account, so it is not suitable as a primary banking provider. It works best alongside a main business bank account.',
      },
      {
        heading: 'Verdict',
        body: 'Aldermore is a solid choice for UK businesses looking to earn a competitive, FSCS-protected return on their cash savings. The four-tier product range (easy access, 95-day notice, 6-month fixed, 1-year fixed) gives businesses flexibility to match their savings strategy to their cash flow needs.',
      },
    ],
    plans: [
      {
      ...
      },
      {
        ...
        features: [
          ...
          'Minimum deposit £1,000',
          'FSCS protected up to £120,000',
          'Short-term certainty on rate',
        ],
        highlight: 'Best for: Short-term fixed returns',
      },
      {
        name: '1-Year Fixed',
        price: '4.00% AER',
    ...
    savingsProducts: [
      {
        productName: 'Aldermore Easy Access Business Savings Account',
        type: 'easy-access',
        aerLabel: '2.45% AER',
        aer: 2.45,
        term: 'Instant access',
      ...
      {
        productName: 'Aldermore 95-Day Notice Business Savings Account',
        type: 'notice',
        aerLabel: '4.00% AER',
        aer: 4.00,
        term: '95-day notice',
      ...
      {
        productName: 'Aldermore 6-Month Fixed Rate Business Savings Account',
        type: 'fixed-rate',
        aerLabel: '3.65% AER',
        aer: 3.65,
        term: '6 months fixed',
      ...
      {
        productName: 'Aldermore 1-Year Fixed Rate Business Savings Account',
        type: 'fixed-rate',
        aerLabel: '4.00% AER',
        aer: 4.00,
        term: '1 year fixed',
  ...
  },
  {
    ...
    welcomeOffer: 'Up to 3.92% AER on 1-year fixed savings',
    welcomeOfferDetail: "Shawbrook offers competitive FSCS-protected business savings rates — 3.40% AER easy access, 3.45% AER 45-day notice, 3.51% AER 100-day notice, 3.92% AER 1-year fixed, and 3.86% AER 2-year fixed. Minimum deposit £1,000.",
    pros: [
      'Competitive savings rates — up to 3.92% AER on 1-year fixed',
      'FSCS protected up to £85,000 per authorised institution',
      'Easy access, 45-day notice, 100-day notice, and fixed-rate bonds available',
    ...
    cons: [
      ...
      '45 or 100-day notice required for notice account withdrawals',
    ],
    summary: "Shawbrook Bank is a multi-award-winning UK specialist savings bank offering FSCS-protected business savings accounts. With easy access, 45-day notice, 100-day notice, and fixed-rate bond options, Shawbrook is a strong choice for businesses that want to earn competitive returns on their cash while keeping it fully protected.",
    reviewContent: [
      {
        heading: 'Overview',
      ...
      {
        heading: 'Savings Rates & Products',
        body: 'Shawbrook offers five business savings products as of March 2026:\n\n- **Easy Access Business Account**: 3.40% AER — instant access, interest paid monthly, min £1,000\n- **45-Day Notice Business Account**: 3.45% AER — 45 days notice required, interest paid monthly, min £5,000\n- **100-Day Notice Business Account**: 3.51% AER — 100 days notice required, interest paid monthly, min £5,000\n- **1-Year Fixed Rate Business Bond**: 3.92% AER — funds locked for 12 months, interest on maturity, min £5,000\n- **2-Year Fixed Rate Business Bond**: 3.86% AER — funds locked for 24 months, interest on maturity, min £5,000',
      },
      {
        heading: 'FSCS Protection',
        body: 'All Shawbrook business savings accounts are fully FSCS protected up to £120,000 per authorised institution. This government-backed protection scheme means your business deposits are safe in the unlikely event that Shawbrook were to fail. This is a key differentiator from e-money providers that use safeguarding instead of FSCS protection.',
      },
      {
        heading: 'Who Is It Best For?',
        body: 'Shawbrook Business Savings is best suited to:\n\n- **Businesses with surplus cash** seeking the highest possible FSCS-protected return\n- **Companies with predictable cash flow** who can commit to 45/100-day notice or 12/24-month fixed terms\n- **Businesses that have already maximised their FSCS allowance** with one provider and want to spread deposits\n- **Charities, not-for-profit organisations, and established SMEs**\n\nShawbrook does not offer a business current account, so it works best alongside a primary business bank account.',
      },
      {
        heading: 'Verdict',
        body: 'Shawbrook is a strong choice for UK businesses looking for FSCS-protected savings. Its five-product range (easy access, two notice accounts, and two fixed-rate bonds) gives businesses genuine flexibility to match their savings strategy to their cash flow needs.',
      },
    ],
    plans: [
      {
      ...
      },
      {
        ...
        monthlyFeeNum: 0,
        features: [
          '45 days notice to withdraw',
          'Interest paid monthly',
          'Minimum deposit £5,000',
          'FSCS protected up to £120,000',
          'Higher rate than easy access',
        ],
        highlight: 'Best for: Businesses with short-term planned cash needs',
      },
      {
        name: '100-Day Notice',
        price: '3.51% AER',
    ...
    savingsProducts: [
      {
        productName: 'Shawbrook Easy Access Business Account',
        type: 'easy-access',
        aerLabel: '3.40% AER',
        aer: 3.40,
        term: 'Instant access',
      ...
      {
        productName: 'Shawbrook 45-Day Notice Business Account',
        type: 'notice',
        aerLabel: '3.45% AER',
        aer: 3.45,
        term: '45-day notice',
      ...
      {
        productName: 'Shawbrook 100-Day Notice Business Account',
        type: 'notice',
        aerLabel: '3.51% AER',
        aer: 3.51,
        term: '100-day notice',
...
export const savingsAccounts: BusinessSavingsAccount[] = [
  {
    ...
    pros: [
      '3.40% AER \u2014 competitive easy access rate',
      'FSCS protected up to \u00a3120,000',
    ...
    summary: "Shawbrook's Easy Access Business Account offers 3.40% AER with full FSCS protection up to \u00a3120,000 and no lock-in period.",
    affiliateUrl: 'https://www.shawbrook.co.uk/business-savings/',
  },
  {
    id: 'shawbrook-100-day-notice',
    provider: 'Shawbrook Bank',
    productName: 'Shawbrook 100-Day Notice Business Account',
    slug: 'shawbrook-business',
    logo: 'https://d2xsxph8kpxj0f.cloudfront.net/310519663463044688/ARsFo8cnc8CpnHoXXZH5qW/shawbrook_logo.png',
    ...
    aer: 3.51,
    aerLabel: '3.51% AER',
    term: '100 days notice',
    termMonths: 3,
    minDeposit: 5000,
    maxDeposit: 2000000,
    minDepositLabel: '\u00a35,000',
    maxDepositLabel: '\u00a32,000,000',
    fscsProtected: true,
    monthlyFee: 'Free',
    monthlyFeeNum: 0,
    interestPaid: 'Monthly',
    ...
    rating: 4.3,
    pros: [
      '3.51% AER \u2014 competitive 100-day notice rate',
      'FSCS protected up to \u00a3120,000',
      'Interest paid monthly',
      'No monthly fee',
    ],
    cons: [
      '100 days notice required to withdraw',
      'Minimum deposit \u00a35,000',
      'Maximum deposit \u00a32,000,000',
    ],
    summary: "Shawbrook's 100-Day Notice Business Account offers 3.51% AER with FSCS protection up to \u00a3120,000.",
    affiliateUrl: 'https://www.shawbrook.co.uk/business-savings/',
  },
  {
    ...
    pros: [
      '3.92% AER \u2014 competitive 1-year fixed business savings rate',
      'FSCS protected up to \u00a3120,000',
    ...
    summary: "Shawbrook's 1-Year Fixed Rate Business Bond offers 3.92% AER with FSCS protection up to \u00a3120,000.",
    affiliateUrl: 'https://www.shawbrook.co.uk/business-savings/',
  },
  {
    ...
    rating: 4.3,
    pros: [
      '3.86% AER guaranteed for 2 years',
      'FSCS protected up to \u00a3120,000',
      'Interest paid on maturity',
      'No monthly fee',
    ],
    ...
    summary: "Shawbrook's 2-Year Fixed Rate Business Bond locks in 3.86% AER for 24 months with FSCS protection up to \u00a3120,000.",
    affiliateUrl: 'https://www.shawbrook.co.uk/business-savings/',
  },
  {
    ...
    rating: 4.0,
    pros: [
      '2.45% AER \u2014 easy access with no lock-in',
      'FSCS protected up to \u00a3120,000',
    ...
    cons: [
      'Minimum deposit \u00a31,000',
      'Rate lower than notice and fixed-rate options',
    ],
    summary: "Aldermore's Easy Access Business Savings Account offers 2.45% AER with instant access and FSCS protection up to \u00a3120,000.",
    affiliateUrl: 'https://www.aldermore.co.uk/savings-accounts/business-savings-accounts/',
  },
  {
    id: 'aldermore-95-day-notice',
    provider: 'Aldermore Bank',
    productName: 'Aldermore 95-Day Notice Business Savings Account',
    slug: 'aldermore-business',
    logo: 'https://d2xsxph8kpxj0f.cloudfront.net/310519663463044688/ARsFo8cnc8CpnHoXXZH5qW/aldermore_logo.png',
    ...
    summary: "Aldermore's 95-Day Notice Business Savings Account offers 4.00% AER with FSCS protection up to \u00a3120,000.",
    affiliateUrl: 'https://www.aldermore.co.uk/savings-accounts/business-savings-accounts/',
  },
  {
    ...
    rating: 4.2,
    pros: [
      '4.00% AER \u2014 competitive 1-year fixed rate',
      'FSCS protected up to \u00a3120,000',
    ...
    summary: "Aldermore's 1-Year Fixed Rate Business Savings Account offers 4.00% AER with FSCS protection up to \u00a3120,000.",
    affiliateUrl: 'https://www.aldermore.co.uk/savings-accounts/business-savings-accounts/',
  },
  {
    id: 'tide-instant-saver',
    provider: 'Tide',
    productName: 'Tide Instant Saver',
    slug: 'tide-business',
    ...
    pros: [
      '4.00% AER (variable) \u2014 excellent rate for an app-based account',
  ...
  },
  {
    ...
    cons: [
      '1.30% AER \u2014 lower than specialist savings banks',
      'Maximum deposit only \u00a3100,000',
      'Only available to Monzo current account holders',
    ],
    summary: "Monzo's Business Instant Access Savings Pot offers 1.30% AER with FSCS protection and instant access via the Monzo app.",
    affiliateUrl: 'https://monzo.com/business/',
  },
  {
    id: 'revolut-savings-account',
    provider: 'Revolut',
    productName: 'Revolut Business Savings Account',
    slug: 'revolut-business',
    ...
    rating: 3.8,
    pros: [
      '2.15% AER (Grow plan) up to 3.3% AER (Enterprise plan)',
      'Interest paid daily',
      'No minimum deposit',
      'Instant access',
    ...
    summary: "Revolut's Business Savings Account offers up to 2.15% AER (Grow plan) with daily interest. Not FSCS protected — funds held in safeguarded accounts.",
